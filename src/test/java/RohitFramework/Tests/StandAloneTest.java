...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		boolean cartProd = cartProducts.stream().anyMatch(product->product.getText().equalsIgnoreCase(Productname));
		Assert.assertTrue(cartProd);

		driver.findElement(By.cssSelector(".totalRow button")).click();

		String emailId = driver.findElement(By.xpath("//*[@class='user__name mt-5']/label")).getText();
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[class*='action__submit']")));
